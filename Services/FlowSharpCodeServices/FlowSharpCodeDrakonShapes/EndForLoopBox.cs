...
{
    [ExcludeFromToolbox]
    public class EndForLoopBox : GraphicElement, IDrakonShape, IEndForLoopBox
    {
        ...
        public override void UpdatePath()
        {
            path = new Point[]
            {
                new Point(ZoomRectangle.X, ZoomRectangle.Y + Y_ADJUST),                                                            // top left of indented left "arrow"
                new Point(ZoomRectangle.X + ZoomRectangle.Width,    ZoomRectangle.Y + Y_ADJUST),                                // top right of indented right "arrow"
                new Point(ZoomRectangle.X + ZoomRectangle.Width, ZoomRectangle.Y + ZoomRectangle.Height/2),                     // right tip (middle of box)
                new Point(ZoomRectangle.X + ZoomRectangle.Width - INDENT_SIZE, ZoomRectangle.Y + ZoomRectangle.Height - Y_ADJUST),         // bottom right of indented right "arrow"
                new Point(ZoomRectangle.X + INDENT_SIZE, ZoomRectangle.Y + ZoomRectangle.Height -  Y_ADJUST),                                  // bottom left of indented left "arrow"
